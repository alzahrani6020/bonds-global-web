  ...
  function renderActionBar(project, lifecycle) {
    ...
    return `
      <div class="action-bar">
        ${nextTransition ? `<button class="ecc-btn ecc-btn--primary" onclick="ProjectCommandCenter.transition('${nextTransition.to}')">Move to ${nextTransition.to}</button>` : ''}
        <button class="ecc-btn ecc-btn--secondary" onclick="ProjectCommandCenter.runReadiness()">Refresh Investment Readiness</button>
        <button class="ecc-btn ecc-btn--secondary" onclick="ProjectCommandCenter.generateMemorandum()">Generate Memorandum</button>
