...
(function() {
  ...
  async function checkProfileCompletion(user, profile) {
    ...
    modal.innerHTML = `
      <div style="background:#ffffff;border:1px solid rgba(184,149,78,0.25);border-radius:20px;max-width:460px;width:100%;max-height:85vh;padding:1.5rem;box-shadow:0 20px 60px rgba(0,0,0,0.6);position:relative;overflow:hidden;font-family:Vazirmatn,system-ui,sans-serif;display:flex;flex-direction:column;">
        <div style="position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#d4a853,#f0c96a,#d4a853);"></div>
        <div style="font-size:2.2rem;margin-bottom:0.5rem;text-align:center;line-height:1;">👋</div>
        <h2 style="text-align:center;color:#d4a853;font-size:1.15rem;font-weight:800;margin-bottom:0.35rem;">أكمل معلوماتك</h2>
        <p style="text-align:center;color:#555555;font-size:0.82rem;margin-bottom:1rem;line-height:1.6;">ساعدنا في تقديم استشارة أفضل بإكمال بياناتك الأساسية.</p>
        <div style="display:flex;flex-direction:column;gap:0.75rem;overflow-y:auto;flex:1;padding-right:0.5rem;">
          <div>
            <label style="display:block;color:#555555;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">المدينة</label>
            <input type="text" id="pcm_city" placeholder="مثال: الرياض" style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#1a1a1a;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#555555;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">النشاط التجاري</label>
            <input type="text" id="pcm_business" placeholder="مثال: مطعم، مقهى، مصنع..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#1a1a1a;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#555555;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">عدد الرواد / الموظفين</label>
            <input type="number" id="pcm_employees" placeholder="0" style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#1a1a1a;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#555555;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">نبذة عن عملك</label>
            <textarea id="pcm_bio" placeholder="وصف مختصر للنشاط..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#1a1a1a;font-family:inherit;font-size:0.9rem;outline:none;min-height:50px;resize:vertical;"></textarea>
          </div>
          <div>
            <label style="display:block;color:#555555;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">احتياجاتك (لتقييم الاستشارة)</label>
            <textarea id="pcm_needs" placeholder="ما تحتاجه من الاستشارة..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#1a1a1a;font-family:inherit;font-size:0.9rem;outline:none;min-height:50px;resize:vertical;"></textarea>
          </div>
        </div>
        ...
        <div style="display:flex;gap:0.75rem;justify-content:center;margin-top:1.5rem;">
          <button id="pcm_save" style="flex:1;padding:0.75rem;border-radius:10px;border:none;background:linear-gradient(135deg,#d4a853,#f0c96a);color:#1a1a1a;font-weight:800;font-size:0.95rem;cursor:pointer;transition:all 0.3s;">💾 حفظ المعلومات</button>
          <button id="pcm_skip" style="padding:0.75rem 1.25rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:transparent;color:#555555;font-weight:700;font-size:0.9rem;cursor:pointer;">لاحقاً</button>
        </div>
      </div>
    `;
