...
(function() {
  ...
  async function checkProfileCompletion(user, profile) {
    ...
    modal.innerHTML = `
      <div style="background:#0d1321;border:1px solid rgba(212,168,83,0.25);border-radius:20px;max-width:460px;width:100%;max-height:85vh;padding:1.5rem;box-shadow:0 20px 60px rgba(0,0,0,0.6);position:relative;overflow:hidden;font-family:Vazirmatn,system-ui,sans-serif;display:flex;flex-direction:column;">
        ...
        <p style="text-align:center;color:#94a3b8;font-size:0.82rem;margin-bottom:1rem;line-height:1.6;">ساعدنا في تقديم استشارة أفضل بإكمال بياناتك الأساسية.</p>
        <div style="display:flex;flex-direction:column;gap:0.75rem;overflow-y:auto;flex:1;padding-right:0.5rem;">
          <div>
            ...
            <input type="text" id="pcm_city" placeholder="مثال: الرياض" style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#e8ecf4;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#94a3b8;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">النشاط التجاري</label>
            <input type="text" id="pcm_business" placeholder="مثال: مطعم، مقهى، مصنع..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#e8ecf4;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#94a3b8;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">عدد الرواد / الموظفين</label>
            <input type="number" id="pcm_employees" placeholder="0" style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#e8ecf4;font-family:inherit;font-size:0.9rem;outline:none;">
          </div>
          <div>
            <label style="display:block;color:#94a3b8;font-size:0.8rem;font-weight:700;margin-bottom:0.35rem;">نبذة عن عملك</label>
            <textarea id="pcm_bio" placeholder="وصف مختصر للنشاط..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#e8ecf4;font-family:inherit;font-size:0.9rem;outline:none;min-height:50px;resize:vertical;"></textarea>
          </div>
          <div>
            ...
            <textarea id="pcm_needs" placeholder="ما تحتاجه من الاستشارة..." style="width:100%;padding:0.6rem 0.9rem;border-radius:10px;border:1px solid rgba(212,168,83,0.2);background:rgba(255,255,255,0.03);color:#e8ecf4;font-family:inherit;font-size:0.9rem;outline:none;min-height:50px;resize:vertical;"></textarea>
          </div>
        </div>
