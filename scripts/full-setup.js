...
async function main() {
    ...
    try {
      ...
      if (!projectRef) {
        ...
        if (dbPassword) {
          ...
          console.log("    Skipped schema execution. Run manually in Supabase SQL Editor.");
        }
      }
    } catch (e) {
  ...
  try {
    ...
    console.log("    Redeploy may have failed. Run manually: vercel --prod");
  }
