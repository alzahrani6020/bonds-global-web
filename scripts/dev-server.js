...
function resolveApiRoute(reqUrl) {
  ...
  const specific = {
    ...
    '/api/track': 'platform.js',
    '/api/track/': 'platform.js',
    '/api/moyasar-checkout': 'payments.js',
    '/api/moyasar-verify': 'payments.js',
    '/api/moyasar-webhook': 'payments.js',
    '/api/moyasar': 'payments.js',
    '/api/moyasar/': 'payments.js',
    '/api/nps-check': 'platform.js',
    '/api/nps-submit': 'platform.js',
    '/api/send-nps': 'platform.js',
    '/api/nps': 'platform.js',
    '/api/nps/': 'platform.js',
    '/api/advisors': 'platform.js',
    '/api/advisors/': 'platform.js',
    '/api/advisor-dashboard': 'platform.js',
    '/api/advisor-update-review': 'platform.js',
    '/api/funding-readiness': 'funding.js',
    '/api/funding-readiness/': 'funding.js',
    '/api/bank-partner-request': 'funding.js',
    '/api/bank-partner-request/': 'funding.js',
    '/api/checkout': 'payments.js',
    '/api/checkout/': 'payments.js',
    '/api/create-checkout': 'payments.js',
    '/api/create-checkout/': 'payments.js',
    '/api/create-oneoff-checkout': 'payments.js',
    '/api/create-oneoff-checkout/': 'payments.js',
    '/api/billing': 'payments.js',
    '/api/billing/': 'payments.js',
    '/api/webhook': 'payments.js',
    '/api/webhook/': 'payments.js',
    ...
    '/api/usage/': 'platform.js',
    '/api/site': 'platform.js',
    '/api/site/': 'platform.js',
    '/api/log-usage': 'platform.js',
    '/api/log-usage/': 'platform.js',
    '/api/image-search': 'research.js',
    '/api/image-search/': 'research.js',
    '/api/market-research': 'research.js',
    '/api/market-research/': 'research.js',
    '/api/promo-simulator': 'research.js',
    '/api/promo-simulator/': 'research.js',
    '/api/omnichannel-calculator': 'research.js',
    '/api/omnichannel-calculator/': 'research.js',
