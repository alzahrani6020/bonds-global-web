...
- **إدارة حالات التمويل (Phase 3)**: كل طلب تمويل ناجح يُنشئ `Funding Case` في قاعدة البيانات برقم مرجعي `BF-YYYY-XXXXXX`، ويُعرض الرقم للعميل بعد الإرسال. تُدار الحالات من لوحة الإدارة عبر `/admin/funding-cases/`.
