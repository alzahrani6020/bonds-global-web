...
const VALID_TYPES = ['credit_assessment', 'feasibility_study', 'distressed_project', 'city_analysis', 'asset_valuation', 'investment_story', 'investment_review', 'break_even_advice'];
...
const REQUIRED_FIELDS = {
  ...
  investment_review: [],
  break_even_advice: ['country', 'fixed_costs', 'variable_cost_per_unit', 'selling_price', 'expected_quantity', 'break_even_units', 'net_profit', 'profit_margin']
};
...
const NUMERIC_FIELDS = {
  ...
  investment_review: [],
  break_even_advice: ['fixed_costs', 'variable_cost_per_unit', 'selling_price', 'expected_quantity', 'platform_fee_pct', 'campaign_discount_pct', 'tax_rate', 'zakat_rate', 'waste_and_incidentals_pct', 'break_even_units', 'break_even_amount', 'net_revenue', 'total_costs', 'gross_profit', 'net_profit', 'profit_margin', 'roi']
};
