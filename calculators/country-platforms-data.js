...
var COUNTRIES_DATA = {
  SA: {
    ...
    platforms: [
      { id: 'plat_hunger', name: 'هنقرستيشن', nameEn: 'HungerStation', fee: 22, confidence: 'verified', freeDelivery: { threshold: 50, restaurantShare: 4.5 } },
      ...
      { id: 'plat_keeta', name: 'كيتا', nameEn: 'Keeta', fee: 15, confidence: 'verified', freeDelivery: { threshold: 40, restaurantShare: 3 } },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
  ...
  AE: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_deliveroo', name: 'ديليفرو', nameEn: 'Deliveroo', fee: 28, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
      { id: 'plat_noon', name: 'نون فود', nameEn: 'Noon Food', fee: 15, confidence: 'estimated' },
      { id: 'plat_keeta', name: 'كيتا', nameEn: 'Keeta', fee: 15, confidence: 'estimated' },
      { id: 'plat_zomato', name: 'زوماتو', nameEn: 'Zomato', fee: 22, confidence: 'estimated' },
      ...
      { id: 'plat_glovo', name: 'غلوفو', nameEn: 'Glovo', fee: 25, confidence: 'estimated' },
      ...
      { id: 'plat_direct', name: 'مباشر (بدون منصة)', nameEn: 'Direct', fee: 0, confidence: 'estimated' }
    ],
  ...
  KW: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 20, confidence: 'estimated' },
      { id: 'plat_carriage', name: 'كاريدج', nameEn: 'Carriage', fee: 22, confidence: 'estimated' },
      { id: 'plat_deliveroo', name: 'ديليفرو', nameEn: 'Deliveroo', fee: 28, confidence: 'estimated' },
      { id: 'plat_keeta', name: 'كيتا', nameEn: 'Keeta', fee: 15, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
  ...
  QA: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_carriage', name: 'كاريدج', nameEn: 'Carriage', fee: 22, confidence: 'estimated' },
      { id: 'plat_snoonu', name: 'سنونو', nameEn: 'Snoonu', fee: 18, confidence: 'estimated' },
      ...
      { id: 'plat_keeta', name: 'كيتا', nameEn: 'Keeta', fee: 15, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
      { id: 'plat_mrsoul', name: 'مرسول', nameEn: 'Mrsool', fee: 15, confidence: 'estimated' },
      ...
      { id: 'plat_eat_easy', name: 'إيت إيزي', nameEn: 'EatEasy', fee: 18, confidence: 'estimated' },
      { id: 'plat_uber', name: 'أوبر إيتس', nameEn: 'Uber Eats', fee: 20, confidence: 'estimated' },
  ...
  BH: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_hunger', name: 'هنقرستيشن', nameEn: 'HungerStation', fee: 22, confidence: 'estimated' },
      { id: 'plat_jahez', name: 'جاهز', nameEn: 'Jahez', fee: 20, confidence: 'estimated' },
      { id: 'plat_deliveroo', name: 'ديليفرو', nameEn: 'Deliveroo', fee: 28, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
      { id: 'plat_glovo', name: 'غلوفو', nameEn: 'Glovo', fee: 25, confidence: 'estimated' },
      { id: 'plat_eat_easy', name: 'إيت إيزي', nameEn: 'EatEasy', fee: 18, confidence: 'estimated' },
  ...
  OM: {
    ...
    platforms: [
      ...
      { id: 'plat_wssel', name: 'وصّل', nameEn: 'Wssel', fee: 18, confidence: 'estimated' },
      { id: 'plat_lugmety', name: 'لقمتي', nameEn: 'Lugmety', fee: 18, confidence: 'estimated' },
      { id: 'plat_toters', name: 'توترز', nameEn: 'Toters', fee: 22, confidence: 'estimated' },
      { id: 'plat_zomato', name: 'زوماتو', nameEn: 'Zomato', fee: 22, confidence: 'estimated' },
      { id: 'plat_keeta', name: 'كيتا', nameEn: 'Keeta', fee: 15, confidence: 'estimated' },
      { id: 'plat_noon', name: 'نون فود', nameEn: 'Noon Food', fee: 15, confidence: 'estimated' },
      { id: 'plat_direct', name: 'مباشر (بدون منصة)', nameEn: 'Direct', fee: 0, confidence: 'estimated' }
  ...
  EG: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_elmenus', name: 'إلمينيوز', nameEn: 'Elmenus', fee: 16, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
      { id: 'plat_noon', name: 'نون فود', nameEn: 'Noon Food', fee: 15, confidence: 'estimated' },
      { id: 'plat_mrsoul', name: 'مرسول', nameEn: 'Mrsool', fee: 18, confidence: 'estimated' },
      { id: 'plat_bolt', name: 'بولت فود', nameEn: 'Bolt Food', fee: 18, confidence: 'estimated' },
  ...
  JO: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم ناو', nameEn: 'Careem NOW', fee: 22, confidence: 'estimated' },
      { id: 'plat_toters', name: 'توترز', nameEn: 'Toters', fee: 25, confidence: 'estimated' },
      { id: 'plat_jahez', name: 'جاهز', nameEn: 'Jahez', fee: 20, confidence: 'estimated' },
  ...
  IQ: {
    ...
    platforms: [
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 22, confidence: 'estimated' },
      { id: 'plat_toters', name: 'توترز', nameEn: 'Toters', fee: 25, confidence: 'estimated' },
      { id: 'plat_careem', name: 'كريم', nameEn: 'Careem', fee: 22, confidence: 'estimated' },
  ...
  LB: {
    ...
    platforms: [
      { id: 'plat_toters', name: 'توترز', nameEn: 'Toters', fee: 30, confidence: 'estimated' },
      { id: 'plat_talabat', name: 'طلبات', nameEn: 'Talabat', fee: 28, confidence: 'estimated' },
  ...
  TN: {
    ...
    platforms: [
      { id: 'plat_glovo', name: 'غلوفو', nameEn: 'Glovo', fee: 28, confidence: 'estimated' },
      { id: 'plat_yassir', name: 'ياسير', nameEn: 'Yassir', fee: 18, confidence: 'estimated' },
      { id: 'plat_jumia', name: 'جوميا فود', nameEn: 'Jumia Food', fee: 14, confidence: 'estimated' },
      { id: 'plat_bolt', name: 'بولت فود', nameEn: 'Bolt Food', fee: 18, confidence: 'estimated' },
  ...
  MA: {
    ...
    platforms: [
      { id: 'plat_glovo', name: 'غلوفو', nameEn: 'Glovo', fee: 30, confidence: 'estimated' },
      { id: 'plat_jumia', name: 'جوميا فود', nameEn: 'Jumia Food', fee: 14, confidence: 'estimated' },
