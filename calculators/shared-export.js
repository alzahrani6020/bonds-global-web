...
function openPrintWindow(options) {
  ...
  var logoHtml = options.hideLogo ? '' : '<img src="https://bonds-global.com/assets/bonds-logo-header.webp" style="width:56px;height:auto;margin-bottom:6px;" alt="Bonds" onerror="this.style.display=\'none\'"/>';
