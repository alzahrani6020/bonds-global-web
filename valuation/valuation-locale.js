  ...
  const VALUATION_LOCALES = {
    ar: {
      ...
      texts: {
        ...
        validationPassed: '✅ البيانات صالحة للتحليل',
        validationFailed: '❌ البيانات غير كافية للتحليل',
    ...
    en: {
      ...
      texts: {
        ...
        validationPassed: '✅ Data is valid for analysis',
        validationFailed: '❌ Data is insufficient for analysis',
