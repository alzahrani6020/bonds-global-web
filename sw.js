...
const CORE_ASSETS = [
  ...
  '/styles/funding-hub.css',
  '/scripts/funding-hub.js',
  '/styles/funding-request-form.css',
  '/scripts/funding-request-form.js',
  '/scripts/funding-context.js',
  ...
  '/global-auth-gate.js?v=3',
  '/bonds-auth-2026.js?v=3.1.2',
  '/supabase-client.js',
  '/lib/formatting.js',
